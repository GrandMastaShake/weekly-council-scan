...
| Total Put/Call Ratio (CBOE) | 0.75 (5D avg 0.79) | 0.81 (5D avg 0.87) | 0.87 | 🟡 **Call-leaning — hedging demand fading** |
| Equity Put/Call Ratio (CBOE) | 0.52 (5D avg 0.51) | 0.58 (5D avg 0.60) | 0.64 | 🔴 **Complacent (5D avg lowest in this sample)** |

> *Source note: VIX prints vary by vendor — discrepancies of ~2–3 pts are common across quote sources (delayed feeds, spot vs. VX futures, stale prints). Canonical reference: CBOE official close / FRED VIXCLS. This week the Friday close was cross-checked directly against the **CBOE official daily history file (VIX_History.csv): Fri 2026-09-25 close 14.87**, an exact match for Yahoo ^VIX (14.87). The CBOE file also matches Yahoo on the week's high (16.57, Thu 9/24). FRED VIXCLS had posted through Mon 9/22 at fetch time (9/21 14.87, 9/22 14.21), both exact matches for Yahoo; it also now confirms last week's published Friday close (2026-09-18: 14.81). **Put/call ratios** are from CBOE's official daily market statistics file (cdn.cboe.com daily_options), Fri 2026-09-25 vs. Fri 2026-09-18 and Wed 2026-08-26. This is the first live put/call read on this page. 5D averages are Mon–Fri of each week; "lowest in this sample" covers the 12 sessions fetched (8/26–8/27, 9/14–9/25), not a long history.*

**Marky Interpretation:** The 10Y put in its first weekly close above 5.00% and the VIX finished the week **up six cents**. VIX closed Friday at **14.87 (+0.41% WoW)**, below its 20-day average (~15.68) and under where it sat a month ago (15.21). It did try: the Thursday spike to **16.57** was the **third straight week that 16.50 was breached intraday and not held on a close**. VIX3M eased to 17.93, the VIX/VIX3M ratio peaked at **0.85** on Thursday and ended at **0.83**, and the term structure never came close to inverting. VVIX held at **87.84**. Implied 30-day SPY move is unchanged at **~±4.3%**. My lines are unchanged: 16.50 is the tell on a close, 20 is the regime question, 25 is the alarm. Last week I said the worry was the options market being calm while bonds sat at 5.00%. This week bonds went to **5.18%** and the options market stayed calm. That gap is now the single largest disagreement on this board. The put/call tape agrees with the VIX, not with bonds. The **equity put/call ratio averaged 0.51 this week (0.60 the week before)** and closed Friday at 0.52, meaning traders are buying calls, not protection, in the week the 10Y broke out.
...
> *Breadth is **live** for the first time since 2026-07-15. S&P 500 rows are computed from the daily closes of all 502 constituents with a Fri 2026-09-25 print (Yahoo, list from Wikipedia's S&P 500 table; 50D/200D = simple MA of closes; a new high/low means the day's high/low reached the trailing 252-session extreme). They are cross-checked against the **Finviz S&P 500 screener**, which agrees within rounding: 26.4% above 50D (133/503), 46.1% above 200D (232/503), 329 up / 172 down, 3 new highs / 32 new lows. Market-wide rows are Finviz's NYSE + Nasdaq + AMEX totals for Friday. The 72-day-old snapshot this page carried (~68% above 50D, ~72% above 200D) was badly out of date: a month ago the real figures were already 54.2% and 70.5%.*

| Metric | Current | 5D Avg | 20D Avg | Regime |
|---|---|---|---|---|
| S&P 500 Advance/Decline (Fri) | **1.91** (328 up / 172 down) | 1.06 | 0.92 | 🟡 **Friday bounce; 20D average still below 1** |
| Market-wide Advance/Decline (Fri, Finviz) | 1.09 (2,762 up / 2,540 down) | — | — | 🟡 **Barely positive on an up day for SPY** |
| S&P 500 New 52-Week Highs | **3** | 9.2 | 9.0 | 🔴 **Near zero** |
| S&P 500 New 52-Week Lows | **31** | 29.8 | 17.4 | 🔴 **Lows ~10x highs; 5D pace ~1.7x the 20D** |
| Market-wide New Highs / Lows (Fri, Finviz) | 67 / 285 | — | — | 🔴 **Lows 81% of the total** |
| **S&P 500 % Above 50D MA** | **26.5%** (1W 28.5%, 1M 54.2%) | 28.2% | 37.8% | 🔴 **Below the 40% red trigger** |
| **S&P 500 % Above 200D MA** | **46.4%** (1W 50.0%, 1M 70.5%) | 47.7% | 56.4% | 🔴 **Under 50% — most members in long-term downtrends** |
| Market-wide % Above 50D / 200D (Fri, Finviz) | 31.9% / 42.0% | — | — | 🔴 **Same picture across all listed stocks** |
| Equal-Weight (RSP) vs. Cap-Weight (SPY), 1W | **-1.82 pts** (RSP -0.56% vs. SPY +1.27%) | — | 1M: **-5.64 pts** | 🔴 **Narrower than last week (-0.86 / -3.45)** |
| Sector ETFs above own 50D MA | **5 of 12** (XLK, XLE, XLV, XLC, SMH) | — | — | 🔴 **Weak participation** |
...
Now we have the real breadth gauges, and they are worse than the proxies suggested. **Only 26.5% of S&P 500 members are above their 50-day average**, down from 54.2% a month ago, while SPY itself sits above its own 50-day. **Fewer than half (46.4%) are above their 200-day.** New lows beat new highs **31 to 3** on Friday, and the 5-day pace of new lows (29.8) is running about 1.7x the 20-day pace (17.4). Friday's 1.91 advance/decline was a real up-day, but the 20-day average is still below 1, and across all listed stocks Friday was barely positive (1.09). The page had been showing ~68% above the 50-day from a July snapshot. The real number has been falling for a month, and this dashboard could not see it.

**Breadth Regime:** 🔴 **Deteriorating (live).** S&P 500 % above 50D (26.5%) is below this board's 40% red trigger.
...
| Market Breadth | 🔴 **Below the red trigger (live gauges)** | S&P 500 26.5% above 50D (1M ago 54.2%), 46.4% above 200D; new highs/lows 3 / 31; RSP -1.82 pts vs. SPY WoW, -5.64 pts 1M | 🟡 <50% above 50D MA | 🔴 <40% |
...
- CBOE: official VIX daily history (cdn.cboe.com VIX_History.csv), Fri 2026-09-25 close 14.87, exact match; VIX3M term structure; daily options market statistics (cdn.cboe.com daily_options) for total / equity / index put/call ratios, 9/14–9/25 and 8/26–8/27
...
- Breadth (live, first refresh since 2026-07-15): S&P 500 constituent closes via Yahoo (502 of 503 members with a Fri print; constituent list from Wikipedia's S&P 500 table), cross-checked against the Finviz S&P 500 screener (idx_sp500 with ta_sma50_pa / ta_sma200_pa / ta_change_u / ta_change_d / ta_highlow52w_nh / nl); market-wide NYSE + Nasdaq + AMEX advance/decline, new highs/lows and % above SMA50/SMA200 from the Finviz homepage market-stats panel (Fri 2026-09-25)
...
*Last updated by Saturday Research Crew: 2026-09-25 (single-agent run; all market data as of Fri 2026-09-25 closes; macro/facts.json regenerated from the same fetch; breadth and put/call refreshed live the same night from S&P 500 constituents / Finviz / CBOE)*
*Next update: Every Saturday 7:39 PM ET*
*Data sources: Yahoo Finance (yfinance), CBOE, FRED, Finviz, Federal Reserve, BEA*
