...
|---|---|---|---|---|---|
| Umassalum | 3 | +0.67% | −0.10% | 3–0 | +2.52% (2026-08-03) |
| GrandMastaShake | 4 | +0.85% | +0.85% | 3–1 | +2.17% (2026-08-17) |
| 🏛️ The Council | 5 | −1.15% | −1.75% | — | — |
...
**Open week:** 2026-08-31 — GrandMastaShake (JPM 25 / CRWD 22 / FCX 20 / GS 18 / MP 10, 95% + 5% cash) and Umassalum (SLV 30 / LNG 15 / JPM 10 / GILD 15 / SPCX 10 / AAPL 10 / LLY 5 / DDOG 5, fully allocated) are locked at Monday's open (SPY $767.33). The Council IS in this week: ALL 13.3% / HIG 13.3% + 73.4% cash (see `reports/2026-08-31-report.md`). Scored at Friday's close (2026-09-04).
